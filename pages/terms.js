	...
	render(){
		return (
			<>
                ...
                <div style={{width:'100%', textAlign:'center', marginTop:'30px'}}><p style={{fontSize:'22px',textAlign:'center', textDecoration:'underline'}}>LEGAL TERMS</p>
                    <div style={{textAlign:'left', padding: '20px', margin:'auto', width: 'auto'}}>
                        ...
                        <p style={{fontWeight:'', marginTop: '30px'}}>Site Ownership</p>
                        ...
                        <p style={{fontWeight:'', marginTop: '30px'}}>Intellectual Property</p>
                        ...
                        <p style={{fontWeight:'', marginTop: '30px'}}>Product Information</p>
                        ...
                        <p style={{fontWeight:'', marginTop: '30px'}}>Social Media Links</p>
                        ...
                        <p style={{fontWeight:'', marginTop: '30px'}}>General</p>
